...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label class="control-label">Fast / Shallow Breathing:</label>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label class="control-label">Chest Pain / Pressure:</label>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <label class="control-label">Fatique / Tiredness:</label>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label">Difficulty Sleeping:</label>
            ...
            <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label">Weight Loss:</label>
